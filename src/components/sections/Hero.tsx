...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden bg-white min-h-[calc(100svh-5rem)] flex items-center justify-center py-12 sm:py-16">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
        ...
        {/* Main Heading */}
        <h1 className="font-[family-name:var(--font-inter)] text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#0B2A3C] tracking-tight leading-[1.1] mb-6 sm:mb-8 max-w-4xl animate-fade-in-up animation-delay-100">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border border-slate-100 mb-6 sm:mb-8 animate-fade-in-up">
          ...
          <span className="text-xs sm:text-sm md:text-base font-semibold text-[#4D555D] tracking-normal sm:tracking-wide uppercase">
        ...
        {/* CTA Buttons */}
        <div className="flex w-full sm:w-auto flex-wrap gap-4 justify-center animate-fade-in-up animation-delay-300">
          <LinkButton href={LINKS.contact} variant="primary" className="w-full sm:w-auto shadow-lg shadow-[#0B2A3C]/10 hover:shadow-xl hover:shadow-[#0B2A3C]/20 transition-all duration-300">
            Contactanos
