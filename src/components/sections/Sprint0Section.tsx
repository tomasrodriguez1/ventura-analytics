    ...
    <Section id="sprint-0" variant="gray">
      <div className="max-w-[1100px] mx-auto w-full space-y-10 md:space-y-12">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-20 xl:gap-28">
          ...
          <div className="lg:flex-1 mb-14 lg:mb-0 lg:-translate-y-6 space-y-8 md:space-y-10">
            ...
            <h2 className="font-[family-name:var(--font-inter)] text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-bold text-[#0B2A3C] leading-tight">
              Prueba el Sprint&nbsp;0{' '}
              <span className="text-[#2FBF71]">(sin costo)</span>
            </h2>
            ...
            <p className="text-base sm:text-lg md:text-xl text-[#6F7A83] leading-relaxed max-w-lg">
              ...
              y tu problema. Luego te entregamos un diagnóstico resumido y una propuesta con las opciones más adecuadas para tu negocio.
            </p>
          </div>
        ...
        <div className="text-center max-w-2xl mx-auto pt-2">
          <p className="text-sm sm:text-base text-[#6F7A83] leading-relaxed">
            Si todavía tienes dudas y no quieres agendar aún, consulta a nuestro Consultor IA para
            ordenar tu caso y explorar posibles caminos de solución.
          </p>
